...
import AppTextInput from '../../components/js/AppInputText';
import AppButton from '../../components/js/AppButton';
import AppText from '../../components/js/AppText';
import Spinner from '../../components/js/Spinner';
import ContainerView from '../../components/js/ContainerView';
import ForgotPasswordComponent from '../../components/js/ForgotPasswordComponent';
import styles from '../../styles/globalStyles';
import {launchCamera, launchImageLibrary} from 'react-native-image-picker';
import ChoosePhotoComponent from '../../components/js/ChoosePhotoComponent';
    ...
    <SafeAreaView style={styles.baseContainer}>
      <ContainerView>
        ...
        <ContainerView viewStyle={{flex: 1}}>
          ...
          <Text style={styles.appText} onPress={onSignInClick}>
          ...
          {showPhotoChooser ? (
            <ChoosePhotoComponent
              ...
              closeClicked={onClosePhotoChooserDialog}
            />
          ) : null}
        </ContainerView>
      </ContainerView>
